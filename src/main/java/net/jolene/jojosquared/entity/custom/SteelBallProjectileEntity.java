...
public class SteelBallProjectileEntity extends PersistentProjectileEntity {
    ...
    public SteelBallProjectileEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public SteelBallProjectileEntity(World world, PlayerEntity player) {
        super(ModEntities.STEEL_BALL, player, world, new ItemStack(ModItems.STEEL_BALL), null);
    }
